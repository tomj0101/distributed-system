# Microsoft Windows Dev Machine setup (Using Windows Subsystem for Linux - CentOS 7) All-in-One
The setup of this script is for run in WSL2 version distro, GNU/Linux CentOS 7, if you are macOS User you can found the equivalence software in .dmg.
...
```  
#sudo yum install wget -y  (CentOS 7 come with wget include)

# htop
sudo yum install htop -y (CentOS 7 come with htop include)

#utility and tools
sudo yum install curl -y (CentOS 7 come with curl include)
