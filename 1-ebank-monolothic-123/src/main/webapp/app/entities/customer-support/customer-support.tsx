      ...
      <h2 id="customer-support-heading" data-cy="CustomerSupportHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="ebankv1App.customerSupport.home.createLabel">Create new Customer Support</Translate>
          </Link>
        </div>
      </h2>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {customerSupport.issueSystem ? (
                      <Link to={`issue-system/${customerSupport.issueSystem.id}`}>{customerSupport.issueSystem.id}</Link>
                    ) : (
                      ''
                    )}
                  </td>
