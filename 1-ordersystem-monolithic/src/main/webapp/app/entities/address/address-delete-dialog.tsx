...
export const AddressDeleteDialog = (props: IAddressDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemApp.address.delete.question">
        <Translate contentKey="ordersystemApp.address.delete.question" interpolate={{ id: addressEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tbl-confirm-delete-address" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
