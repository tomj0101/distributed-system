  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemApp.address.home.createOrEditLabel" data-cy="AddressCreateUpdateHeading">
            <Translate contentKey="ordersystemApp.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : addressEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="address-id">
                    <Translate contentKey="ordersystemApp.address.id">Id</Translate>
                  </Label>
              ...
              <AvGroup>
                <Label id="streetAddressLabel" for="address-streetAddress">
                  <Translate contentKey="ordersystemApp.address.streetAddress">Street Address</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="postalCodeLabel" for="address-postalCode">
                  <Translate contentKey="ordersystemApp.address.postalCode">Postal Code</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label id="cityLabel" for="address-city">
                  <Translate contentKey="ordersystemApp.address.city">City</Translate>
                </Label>
                <AvField
                  id="address-city"
                  data-cy="city"
              ...
              <AvGroup>
                <Label id="stateProvinceLabel" for="address-stateProvince">
                  <Translate contentKey="ordersystemApp.address.stateProvince">State Province</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label for="address-user">
                  <Translate contentKey="ordersystemApp.address.user">User</Translate>
                </Label>
                <AvInput id="address-user" data-cy="user" type="select" className="form-control" name="userId">
                  <option value="" key="0" />
                  {users
