...
export const OrderMasterDeleteDialog = (props: IOrderMasterDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemApp.orderMaster.delete.question">
        <Translate contentKey="ordersystemApp.orderMaster.delete.question" interpolate={{ id: orderMasterEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tbl-confirm-delete-orderMaster" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
