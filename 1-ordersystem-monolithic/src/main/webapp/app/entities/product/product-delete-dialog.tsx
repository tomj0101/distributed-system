...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemApp.product.delete.question">
        <Translate contentKey="ordersystemApp.product.delete.question" interpolate={{ id: productEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="tbl-confirm-delete-product" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
