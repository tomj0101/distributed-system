...
@RestController
@RequestMapping("/api/ordersystemv-2-kafka")
public class Ordersystemv2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Ordersystemv2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Ordersystemv2KafkaResource(KafkaProperties kafkaProperties) {
