    ...
    <Row>
      <Col md="8">
        <h2 data-cy="addressDetailsHeading">
          <Translate contentKey="ordersystemv2App.address.detail.title">Address</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="ordersystemv2App.address.id">Id</Translate>
            </span>
          </dt>
          <dd>{addressEntity.id}</dd>
          <dt>
            <span id="streetAddress">
              <Translate contentKey="ordersystemv2App.address.streetAddress">Street Address</Translate>
            </span>
          </dt>
          <dd>{addressEntity.streetAddress}</dd>
          <dt>
            <span id="postalCode">
              <Translate contentKey="ordersystemv2App.address.postalCode">Postal Code</Translate>
            </span>
          </dt>
          <dd>{addressEntity.postalCode}</dd>
          <dt>
            <span id="city">
              <Translate contentKey="ordersystemv2App.address.city">City</Translate>
            </span>
          </dt>
          <dd>{addressEntity.city}</dd>
          <dt>
            <span id="stateProvince">
              <Translate contentKey="ordersystemv2App.address.stateProvince">State Province</Translate>
            </span>
          </dt>
          <dd>{addressEntity.stateProvince}</dd>
          <dt>
            <Translate contentKey="ordersystemv2App.address.user">User</Translate>
          </dt>
