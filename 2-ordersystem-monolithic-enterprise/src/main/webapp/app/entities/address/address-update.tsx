  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemv2App.address.home.createOrEditLabel" data-cy="AddressCreateUpdateHeading">
            <Translate contentKey="ordersystemv2App.address.home.createOrEditLabel">Create or edit a Address</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
