...
export const OrderMasterDeleteDialog = (props: IOrderMasterDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemv2App.orderMaster.delete.question">
        <Translate contentKey="ordersystemv2App.orderMaster.delete.question" interpolate={{ id: orderMasterEntity.id }}>
