  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemv2App.orderMaster.home.createOrEditLabel" data-cy="OrderMasterCreateUpdateHeading">
            <Translate contentKey="ordersystemv2App.orderMaster.home.createOrEditLabel">Create or edit a OrderMaster</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : orderMasterEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="order-master-id">
                    <Translate contentKey="ordersystemv2App.orderMaster.id">Id</Translate>
                  </Label>
              ...
              <AvGroup>
                <Label id="totalLabel" for="order-master-total">
                  <Translate contentKey="ordersystemv2App.orderMaster.total">Total</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="emailLabel" for="order-master-email">
                  <Translate contentKey="ordersystemv2App.orderMaster.email">Email</Translate>
                </Label>
                <AvField
              ...
              <AvGroup>
                <Label for="order-master-address">
                  <Translate contentKey="ordersystemv2App.orderMaster.address">Address</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="order-master-status">
                  <Translate contentKey="ordersystemv2App.orderMaster.status">Status</Translate>
                </Label>
              ...
              <AvGroup>
                <Label for="order-master-user">
                  <Translate contentKey="ordersystemv2App.orderMaster.user">User</Translate>
                </Label>
