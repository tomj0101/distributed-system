...
import { getSearchEntities, getEntities } from './order-master.reducer';
  ...
  return (
    <div>
      <h2 id="order-master-heading" data-cy="OrderMasterHeading">
        <Translate contentKey="ordersystemv2App.orderMaster.home.title">Order Masters</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ordersystemv2App.orderMaster.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ordersystemv2App.orderMaster.home.createLabel">Create new Order Master</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('ordersystemv2App.orderMaster.home.search')}
                />
        ...
        {orderMasterList && orderMasterList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ordersystemv2App.orderMaster.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('paymentMethod')}>
                  <Translate contentKey="ordersystemv2App.orderMaster.paymentMethod">Payment Method</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('total')}>
                  <Translate contentKey="ordersystemv2App.orderMaster.total">Total</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="ordersystemv2App.orderMaster.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('registerDate')}>
                  <Translate contentKey="ordersystemv2App.orderMaster.registerDate">Register Date</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ordersystemv2App.orderMaster.address">Address</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ordersystemv2App.orderMaster.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="ordersystemv2App.orderMaster.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ordersystemv2App.orderMaster.home.notFound">No Order Masters found</Translate>
            </div>
          )
        )}
      </div>
