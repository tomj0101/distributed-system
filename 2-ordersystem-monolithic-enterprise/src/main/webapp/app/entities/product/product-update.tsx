  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemv2App.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="ordersystemv2App.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="product-id">
                    <Translate contentKey="ordersystemv2App.product.id">Id</Translate>
                  </Label>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-name">
                  <Translate contentKey="ordersystemv2App.product.name">Name</Translate>
                </Label>
                <AvField
                  id="product-name"
                  data-cy="name"
              ...
              <AvGroup>
                <Label id="descriptionLabel" for="product-description">
                  <Translate contentKey="ordersystemv2App.product.description">Description</Translate>
                </Label>
              ...
              <AvGroup>
                <AvGroup>
                  <Label id="productImagesLabel" for="productImages">
                    <Translate contentKey="ordersystemv2App.product.productImages">Product Images</Translate>
                  </Label>
                  <br />
                  {productImages ? (
                    <div>
              ...
              <AvGroup>
                <Label id="priceLabel" for="product-price">
                  <Translate contentKey="ordersystemv2App.product.price">Price</Translate>
                </Label>
              ...
              <AvGroup>
                <Label id="conditionLabel" for="product-condition">
                  <Translate contentKey="ordersystemv2App.product.condition">Condition</Translate>
                </Label>
                <AvInput
                ...
                >
                  <option value="NEW">{translate('ordersystemv2App.Condition.NEW')}</option>
                  <option value="USED">{translate('ordersystemv2App.Condition.USED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup check>
                <Label id="activeLabel">
                  <AvInput id="product-active" data-cy="active" type="checkbox" className="form-check-input" name="active" />
                  <Translate contentKey="ordersystemv2App.product.active">Active</Translate>
                </Label>
              </AvGroup>
              <AvGroup>
                <Label id="registerDateLabel" for="product-registerDate">
                  <Translate contentKey="ordersystemv2App.product.registerDate">Register Date</Translate>
                </Label>
                <AvInput
