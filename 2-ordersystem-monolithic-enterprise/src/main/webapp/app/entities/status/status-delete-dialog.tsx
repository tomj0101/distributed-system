...
export const StatusDeleteDialog = (props: IStatusDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemv2App.status.delete.question">
        <Translate contentKey="ordersystemv2App.status.delete.question" interpolate={{ id: statusEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-status" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
