  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemv2App.status.home.createOrEditLabel" data-cy="StatusCreateUpdateHeading">
            <Translate contentKey="ordersystemv2App.status.home.createOrEditLabel">Create or edit a Status</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
