...
class AddressResourceIT {
     ...
     *
     * @see com.github.tomj0101.ebankv1.ordersystemv2.repository.search.AddressSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.streetAddress(UPDATED_STREET_ADDRESS).city(UPDATED_CITY).stateProvince(UPDATED_STATE_PROVINCE);
