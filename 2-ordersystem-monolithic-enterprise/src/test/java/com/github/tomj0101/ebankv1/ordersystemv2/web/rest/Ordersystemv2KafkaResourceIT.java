...
import com.github.tomj0101.ebankv1.ordersystemv2.config.KafkaProperties;
...
class Ordersystemv2KafkaResourceIT {
    ...
    private static void startTestcontainer() {
        ...
        // See discussion athttps://github.com/tomj0101/distributed-system/issues/11544#issuecomment-609065206
    ...
    void setup() {
        ...
        Ordersystemv2KafkaResource kafkaResource = new Ordersystemv2KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/ordersystemv-2-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/ordersystemv-2-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
