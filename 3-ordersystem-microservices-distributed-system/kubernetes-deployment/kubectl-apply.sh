...
logSummary() {
    echo ""
        ...
        echo "Grafana - http://jhipster-grafana.ebankNamespace."
        echo "#####################################################"
}
...
default() {
    ...
    kubectl apply -f addressapi-${suffix}/
    kubectl apply -f orderapi-${suffix}/
    kubectl apply -f ordersystemfrontend-${suffix}/
    kubectl apply -f productapi-${suffix}/
    kubectl apply -f statusapi-${suffix}/
