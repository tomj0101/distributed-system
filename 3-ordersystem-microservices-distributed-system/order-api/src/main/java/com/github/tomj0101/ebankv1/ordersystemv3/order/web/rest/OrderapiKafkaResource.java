...
@RestController
@RequestMapping("/api/orderapi-kafka")
public class OrderapiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OrderapiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public OrderapiKafkaResource(KafkaProperties kafkaProperties) {
