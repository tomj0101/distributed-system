...
import com.github.tomj0101.ebankv1.ordersystemv3.ordersystemfrontend.config.KafkaProperties;
...
@RestController
@RequestMapping("/api/ordersystemfrontend-kafka")
public class OrdersystemfrontendKafkaResource {

    private final Logger log = LoggerFactory.getLogger(OrdersystemfrontendKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaSender<String, String> sender;

    public OrdersystemfrontendKafkaResource(KafkaProperties kafkaProperties) {
