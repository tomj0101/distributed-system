  ...
  return (
    <div>
      <h2 id="order-master-heading" data-cy="OrderMasterHeading">
        <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.home.title">Order Masters</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.home.createLabel">Create new Order Master</Translate>
          </Link>
        </div>
      </h2>
      <Row>
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('ordersystemfrontendApp.orderapiOrderMaster.home.search')}
                />
        ...
        {orderMasterList && orderMasterList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('total')}>
                  <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.total">Total</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('email')}>
                  <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.email">Email</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="ordersystemfrontendApp.orderapiOrderMaster.home.notFound">No Order Masters found</Translate>
            </div>
          )
        )}
      </div>
