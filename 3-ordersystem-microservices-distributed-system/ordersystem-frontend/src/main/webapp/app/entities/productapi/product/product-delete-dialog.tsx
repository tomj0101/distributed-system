...
export const ProductDeleteDialog = (props: IProductDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="ordersystemfrontendApp.productapiProduct.delete.question">
        <Translate contentKey="ordersystemfrontendApp.productapiProduct.delete.question" interpolate={{ id: productEntity.id }}>
