...
import { IProduct, defaultValue } from 'app/shared/model/productapi/product.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    it('should set state to loading', () => {
      testMultipleTypes(
        [REQUEST(ACTION_TYPES.FETCH_PRODUCT_LIST), REQUEST(ACTION_TYPES.SEARCH_PRODUCTS), REQUEST(ACTION_TYPES.FETCH_PRODUCT)],
        {},
        state => {
          expect(state).toMatchObject({
            errorMessage: null,
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.SEARCH_PRODUCTS),
  ...
  describe('Successes', () => {
    ...
    it('should search all entities', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.SEARCH_PRODUCTS),
          payload,
        })
      ).toEqual({
        ...initialState,
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.SEARCH_PRODUCTS actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.SEARCH_PRODUCTS),
        },
        {
          type: SUCCESS(ACTION_TYPES.SEARCH_PRODUCTS),
          payload: resolvedObject,
