  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ordersystemfrontendApp.productapiProduct.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="ordersystemfrontendApp.productapiProduct.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <AvForm model={isNew ? {} : productEntity} onSubmit={saveEntity}>
              {!isNew ? (
                <AvGroup>
                  <Label for="product-id">
                    <Translate contentKey="ordersystemfrontendApp.productapiProduct.id">Id</Translate>
                  </Label>
              ...
              <AvGroup>
                <Label id="nameLabel" for="product-name">
                  <Translate contentKey="ordersystemfrontendApp.productapiProduct.name">Name</Translate>
                </Label>
                <AvField
                  id="product-name"
                  data-cy="name"
              ...
              <AvGroup>
                <Label id="priceLabel" for="product-price">
                  <Translate contentKey="ordersystemfrontendApp.productapiProduct.price">Price</Translate>
                </Label>
              ...
              <AvGroup>
                ...
                >
                  <option value="NEW">{translate('ordersystemfrontendApp.Condition.NEW')}</option>
                  <option value="USED">{translate('ordersystemfrontendApp.Condition.USED')}</option>
                </AvInput>
              </AvGroup>
              <AvGroup check>
