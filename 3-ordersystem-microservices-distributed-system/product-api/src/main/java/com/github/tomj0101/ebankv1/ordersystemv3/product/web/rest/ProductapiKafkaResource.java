...
@RestController
@RequestMapping("/api/productapi-kafka")
public class ProductapiKafkaResource {

    private final Logger log = LoggerFactory.getLogger(ProductapiKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public ProductapiKafkaResource(KafkaProperties kafkaProperties) {
