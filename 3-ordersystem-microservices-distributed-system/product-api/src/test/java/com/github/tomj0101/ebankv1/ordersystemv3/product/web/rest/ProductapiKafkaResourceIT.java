package com.github.tomj0101.ebankv1.ordersystemv3.product.web.rest;
...
import com.github.tomj0101.ebankv1.ordersystemv3.product.config.KafkaProperties;
...
class ProductapiKafkaResourceIT {
    ...
    private static void startTestcontainer() {
        ...
        // See discussion at https://github.com/tomj0101/distributed-system/issues/11544#issuecomment-609065206
    ...
    void setup() {
        ...
        ProductapiKafkaResource kafkaResource = new ProductapiKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/productapi-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/productapi-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
